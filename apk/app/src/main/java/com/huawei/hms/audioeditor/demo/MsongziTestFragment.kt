...
//// 设置音频的格式参数，返回设置结果res（注：当res为HAEErrorCode.SUCCESS时才可进行后续操作）
//        val res: Int = haeChangeVoiceStream.setAudioFormat(BIT_DEPTH, CHANNEL_COUNT, SAMPLE_RATE)
...
//// 设置音频的格式参数，返回设置结果res（注：当res为HAEErrorCode.SUCCESS时才可进行后续操作）
//// 设置音频的格式参数，返回设置结果res（注：当res为HAEErrorCode.SUCCESS时才可进行后续操作）
//        val res: Int = haeChangeVoiceStreamCommon.setAudioFormat(BIT_DEPTH, CHANNEL_COUNT, SAMPLE_RATE)
//// 对PCM数据（buffer）进行变声操作，返回变声后的PCM数据（resultByte）
//// 对PCM数据（buffer）进行变声操作，返回变声后的PCM数据（resultByte）
//        while (buffer != null) {
...
//// 设置音频的格式参数，返回设置结果res（注：当res为HAEErrorCode.SUCCESS时才可进行后续操作）
//// 设置音频的格式参数，返回设置结果res（注：当res为HAEErrorCode.SUCCESS时才可进行后续操作）
//        val res: Int = haeVoiceBeautifierStream.setAudioFormat(BIT_DEPTH, CHANNEL_COUNT, SAMPLE_RATE)
//// 对PCM数据（buffer）进行变声操作，返回变声后的PCM数据（resultByte）
//// 对PCM数据（buffer）进行变声操作，返回变声后的PCM数据（resultByte）
//        while (buffer != null) {
...
//// 设置音频的格式参数，返回设置结果res（注：当res为HAEErrorCode.SUCCESS时才可进行后续操作）
//// 设置音频的格式参数，返回设置结果res（注：当res为HAEErrorCode.SUCCESS时才可进行后续操作）
//        var res = haeSceneStream.setAudioFormat(BIT_DEPTH, CHANNEL_COUNT, SAMPLE_RATE)
...
//// 设置音频的格式参数，返回设置结果res（注：当res为HAEErrorCode.SUCCESS时才可进行后续操作）
//// 设置音频的格式参数，返回设置结果res（注：当res为HAEErrorCode.SUCCESS时才可进行后续操作）
//        var res = haeSoundFieldStream.setAudioFormat(BIT_DEPTH, CHANNEL_COUNT, SAMPLE_RATE)
...
//// 设置均衡的格式参数，返回设置结果res（注：当res为HAEErrorCode.SUCCESS时才可进行后续操作）
//        var res = haeEqualizerStream.setAudioFormat(BIT_DEPTH, CHANNEL_COUNT, SAMPLE_RATE)
//// 设置声场类型，返回设置结果res（注：当res为HAEErrorCode.SUCCESS时才可进行后续操作）
//// 设置声场类型，返回设置结果res（注：当res为HAEErrorCode.SUCCESS时才可进行后续操作）
...
//// 设置音频的格式参数，返回设置结果res（注：当res为HAEErrorCode.SUCCESS时才可进行后续操作）
//// 设置音频的格式参数，返回设置结果res（注：当res为HAEErrorCode.SUCCESS时才可进行后续操作）
//        var res = haeNoiseReductionStream.setAudioFormat(BIT_DEPTH, CHANNEL_COUNT, SAMPLE_RATE)
